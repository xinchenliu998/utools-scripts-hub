...
export default {
  ui: {
    ...
    dialogOptions: {
      selectFile: { title: '选择文件', buttonLabel: '选择' },
      selectFolder: { title: '选择文件夹', buttonLabel: '选择' },
    },
    formLabels: {
      themeColor: '主题色：',
      excludeCustom: '排除文件夹：',
    ...
    placeholders: {
      ...
      excludeFolders: '例如: temp, logs, node_modules',
      searchRule: '搜索规则（名称、模式、应用、描述）',
      searchScript: '搜索脚本（名称、路径、描述、关键词）',
      searchScriptRun: '输入文件名或关键字搜索脚本...',
      excludeFoldersExample: '例如: temp, logs, node_modules',
    },
    notifications: {
      saved: '设置已保存',
      reset: '已重置为默认值',
