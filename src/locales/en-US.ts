...
export default {
  ui: {
    ...
    formLabels: {
      ...
      scriptExcludeFolders: 'Exclude folders:',
    ...
    placeholders: {
      ...
      excludeFolders: 'e.g.: temp, logs, node_modules',
      ...
      excludeFoldersExample: 'e.g.: temp, logs, node_modules',
    },
    notifications: {
